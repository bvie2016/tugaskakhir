...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Data Laboratorium</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <form action="{{route('aset.store')}}" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $data->tahun_pengadaan }}" name="tahun_pengadaan" id="inputClientCompany" class="form-control" readonly>
                          </div>
                          <div class="form-group">
                            ...
                            <select name="tipe_id" id="" class="form-control" required>
                              ...
                              @foreach ($tipe as $item)
                                  <option value="{{$item->id}}" {{ $data->tipe_id == $item->id ? 'selected' : ''}}>{{$item->nama}}</option>
                              @endforeach
                          </select>
                          </div>
                          <div class="form-group">
                            ...
                            <select name="jenis_id" id="" class="form-control" required>
                              ...
                              @foreach ($jenis as $item)
                                  <option value="{{$item->id}}"  {{$data->jenis_id == $item->id}}>{{$item->nama}}</option>
                              @endforeach
                          </select>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" value="{{ $data->kode }}" name="kode" id="inputClientCompany" class="form-control">
                          </div>
                          <div class="form-group">
                            <label for="inputName">NAMA BARANG</label>
                            <input type="text" value="{{ $data->nama }}" name="nama" id="inputClientCompany" class="form-control">
                          </div>
                          <div class="form-group">
                  ...
                  <div class="card-footer">
                      ...
                      <input type="button" value="update" class="btn btn-success float-right">
                  </div>
