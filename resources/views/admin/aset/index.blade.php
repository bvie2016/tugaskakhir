            ...
            <div class="col-16">
                <div class="card">
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{route('aset.show', $item->id)}}" class="btn btn-info btn-sm">Lihat</a>
                              <a href="{{route('aset.edit', $item->id)}}" class="btn btn-warning btn-sm">Edit</a>
                            </td>
                          </tr>   
                          @endforeach
                    ...
                    <div class="card-footer clearfix">
                      <a href="{{route('aset.create')}}" class="btn btn-primary float-right"><i class="fas fa-plus">
                        </i> Tambah Data</a>
