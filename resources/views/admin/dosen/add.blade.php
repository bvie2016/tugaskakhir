...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">INPUT DATA DOSEN</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <form action="{{route('dosen.store')}}" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="nidn" id="inputClientCompany" class="form-control">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="kontak" id="inputClientCompany" class="form-control">

                          </div>
                          <div class="form-group">
                            <label for="inputName">HAK AKSES</label>
                            <select name="hakakses" id="" class="form-control">
