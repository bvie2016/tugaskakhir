      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{ route('jenis.index')}}" class="nav-link {{Request::is('jenis') ? 'active' : ''}}">
            ...
            @hasanyrole('admin')
            <li class="nav-item">
              <a href="{{ route('ruang.index')}}" class="nav-link {{Request::is('ruang') ? 'active' : ''}}">
                <i class="far fa-circle nav-icon"></i>
                <p>Ruang</p>
              </a>
              @endhasanyrole
        ...
        @hasanyrole('admin')
          ...
          @hasanyrole('admin')
          <li class="nav-item">
            <a href={{ route('hakakses.index')}} class="nav-link {{Request::is('hakakses') ? 'active' : ''}}">
              <i class="far fa-circle nav-icon"></i>
              <p>HAK ASKES</p>
            </a>
          </li>
