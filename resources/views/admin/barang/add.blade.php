                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="stok" id="inputClientCompany" class="form-control">
                          </select>
                          </div>
                          <div class="form-group">
                            <label for="inputName">STATUS</label>
                                <input type="text" name="status" id="inputClientCompany" class="form-control">
                          </div>
                  <div class="card-footer">
                      <a href="{{route('barang.create')}}" class="btn btn-secondary">Cancel</a>
